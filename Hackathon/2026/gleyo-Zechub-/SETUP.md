...
> Zebra must sync to the Ironwood activation height (~3.42M blocks) before Nozy can operate. A full sync to the current Zcash mainnet tip is required for live withdrawals and deposit verification.
